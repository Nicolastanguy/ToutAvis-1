...
public class TestAddItemFilm {
	...
	public static void sequenceTestAddItemFilm() {
		...
		nbTests++;
		nbErreurs += addItemFilmNotMemberTest ( sn, "membreInexistant", "password", "", "", "", "", 120, "6.2", "L'ajout d'un film avec un membre inexistant est accepté");
		nbTests++;
		nbErreurs += addItemFilmNotMemberTest ( sn, "Personne1", "mauvaisPassword", "", "", "", "", 120, "6.3", "L'ajout d'un film avec un membre existant et un mauvais password est accepté");
		
		// tentative d'ajout de films "existant"
		
		nbTests++;
		nbErreurs += addItemFilmBadEntryTest ( sn, "Personne1", "psw1", "titre1", "", "", "", 120, "6.4", "L'ajout d'un film avec le titre du premier livre ajouté est accepté");
		nbTests++;
		nbErreurs += addItemFilmBadEntryTest ( sn, "Personne1", "psw1", "titre3", "", "", "", 120, "6.5", "L'ajout d'un film avec le titre du dernier livre ajouté est accepté");
		nbTests++;
		nbErreurs += addItemFilmBadEntryTest ( sn, "Personne1", "psw1", "tiTre2", "", "", "", 120, "6.6", "L'ajout d'un film avec un titre existant (avec casse différente) est accepté");
		nbTests++;
		nbErreurs += addItemFilmBadEntryTest ( sn, "Personne1", "psw1", " titre2 ", "", "", "", 120, "6.7", "L'ajout d'un film avec un titre existant (avec leading et trailing blanks) est accepté");
