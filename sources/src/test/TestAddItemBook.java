...
public class TestAddItemBook {
	...
	public static void sequenceTestAddItemBook() {
		...
		nbTests++;
		nbErreurs += addItemBookAlreadyExistsTest ( sn, "Personne1", "psw1", "titre1", "genre1", "auteur1", 150, "4.4", "L'ajout d'un livre avec le titre du premier livre ajouté est accepté");
		nbTests++;
		nbErreurs += addItemBookAlreadyExistsTest ( sn, "Personne1", "psw1", "titre3", "genre3", "auteur3", 10, "4.5", "L'ajout d'un livre avec le titre du dernier livre ajouté est accepté");
		nbTests++;
		nbErreurs += addItemBookAlreadyExistsTest ( sn, "Personne1", "psw1", "tiTre2", "genre2", "auteur2", 10, "4.6", "L'ajout d'un livre avec un titre existant (avec casse différente) est accepté");
		nbTests++;
